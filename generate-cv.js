...
const PDF_OUTPUT  = path.join(__dirname, 'Abdelaziz-Omar-Resume.pdf');
...
@media print {
  ...
  body { font-size: 10pt; }
  .cv-wrap { padding: 0; max-width: 100%; width: 100%; }
...
<div id="toolbar" class="no-print">
  ...
  <a class="tb-pdf" href="Abdelaziz-Omar-Resume.pdf" download="Abdelaziz-Omar-Resume.pdf">
...
async function main() {
  ...
  await browser.close();
  console.log(`✓ ${path.basename(PDF_OUTPUT)}  → ${PDF_OUTPUT}`);
}
